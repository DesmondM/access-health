...
import funeralData from './FuneralData.json'
...
const Home = () => {
    ...
    const [funeralUserValues, setFuneralUserValues] = useState({
        plan: "Funeral Plan",
        cover: "",
        coverAmount: "",
        ageGroup: "",
...
const handleProductType = (e) => {
    ...
    const handleFuneralPremiumInput = (e) => {
        e.preventDefault();
        setUserValues({
            plan: "",
            membership: "",
                                ...
                                <div className="row d-flex align-items-center">
                                    ...
                                    <div className="col-lg-5 col-xl-5">
                                        <div id="hero-section-form" className="text-center mb-40 mt-50">
                                            ...
                                            >
                                                ...
                                                {/* <div id="input-product" className="col-md-12 input-product">
                                                    <select id="inlineFormCustomSelect2" name="membership" className="custom-select product" required
                                                        ...
                                                        <option value={"Single Member"}>What are you looking for?</option>
                                                        <option value={"funeralInsurance"}>Funeral Insurance</option>
                                                        <option value={"Couple"}>Health Insurance</option>
                                                        <option value={"Couple"}>Legal Insurance</option>
                                                    </select>
                                                </div> */}
                                                <div id="input-product" className="col-md-12 input-product">
                                                    <select id="inlineFormCustomSelect2" name="membership" className="custom-select product" required
                                                        ...
                                                        <option value={"legalInsurance"}>Legal Insurance</option>
                                                    </select>
                                                </div>
                                             {selectedProduct === 'funeralInsurance' ? 
                                             
                                             (<div style={{width:'100%'}}>Funeral
                                             ...
                                             <div id="input-cover" className="col-md-12 input-cover">
                                                    <select id="inlineFormCustomSelect2" name="cover" className="custom-select cover" required
                                                        onChange={handleFuneralPremiumInput}>
                                                        ...
                                                        <option value={"Traditional Parlour Product"}>Traditional Parlour Product</option>
                                             ...
                                             {/* <div id="input-cover" className="col-md-12 input-cover">
                                                    <select id="inlineFormCustomSelect2" name="plan" className="custom-select cover" required
                                                        onChange={handleFuneralPremiumInput}>

                                                        <option value={"Funeral Plan"}>Plan</option>
                                                        <option value={"Funeral Plan"}>Funeral Plan</option>
                                                       
                                                    </select>
                                                </div> */}
                                               
                                                {funeralUserValues.cover === 'Traditional Parlour Product' ?
                                             <div id="input-cover" className="col-md-12 input-cover">
                                                    <select id="inlineFormCustomSelect2" name="plan" className="custom-select cover" required
                                                        onChange={handleFuneralPremiumInput}>
                                            ...
                                            <div id="input-cover" className="col-md-12 input-cover">
                                                    <select id="inlineFormCustomSelect2" name="ageGroup" className="custom-select cover" required
                                                        onChange={handleFuneralPremiumInput}>

                                                        <option value={""}>Age group</option>
                                                        <option value={"0-65"}>0-65yrs</option>
                                                        <option value={"0-75"}>0-75yrs</option>
                                            ...
                                            <div id="input-cover" className="col-md-12 input-cover">
                                                    <select id="inlineFormCustomSelect2" name="ageGroup" className="custom-select cover" required
                                                        ...
                                                        <option value={""}>Age group</option>
                                                        <option value={"18-64"}>18-64yrs</option>
                                                        <option value={"65-74"}>65-74yrs</option>
                                                        <option value={"75-84"}>75-84yrs</option>
                                             ...
                                             <div id="input-cover" className="col-md-12 input-cover">
                                                    <select id="inlineFormCustomSelect2" name="coverAmount" className="custom-select cover" required
                                                        onChange={handleFuneralPremiumInput}>

                                                        <option value={""}>Amount of cover required</option>
                                              ...
                                              :<div style={{width:'100%'}}>
                                                ...
                                                {funeralData
                                                    .filter(
                                                        (frecord) =>
                                                            frecord.cover === `${funeralUserValues.cover}` &&
                                                            frecord.ageGroup === `${funeralUserValues.ageGroup}` &&
                                                            frecord.coverAmount === `${funeralUserValues.coverAmount}` &&
                                                            frecord.plan === `${funeralUserValues.plan}`
                                                    )
                                                    .map((filteredRecords) => (
                                                        <p style={{
                                                            color: '#fff',
                                                            ...
                                                            >
                                                                ...
                                                                <div style={{ display: 'flex', flexDirection: 'row', gap: '10px', width: '380px', justifyContent: 'center' }}><h2 className="h2-xs" style={{ color: 'white' }}> {filteredRecords.premium? (filteredRecords.premium):'No record'}</h2><span><p style={{ width: '200px', marginRight: '-55px', marginTop: '40px', padding: '0 0 15px 0', float: 'center' }}>Per Month</p></span></div>
                                                            </span>
